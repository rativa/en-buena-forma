...
public class Main2Activity_Nivel1 extends AppCompatActivity {
    ...
    String nombre_jugador, altura_jugador, peso_jugador, string_score, string_vidas;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        altura_jugador = getIntent().getStringExtra("jugadorAltura");
        peso_jugador = getIntent().getStringExtra("jugadorPeso");
    ...
    public void NumAleatorio(){
        if(score <= 9){
            ...
            if(resultado <= 10){
                ...
                NumAleatorio();
                //Recursividad, la suma tiene que ser menor a 10
            }
